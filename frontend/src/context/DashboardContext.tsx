...
export function DashboardContextProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchMeals = async () => {
    try {
      ...
      if (process.env.NEXT_PUBLIC_NODE_ENV !== 'production') console.log('nutrition fact fetched successfully:', nutritiontea.data.candidates[0].content.parts[0].text);
  ...
  //     if (process.env.NEXT_PUBLIC_NODE_ENV !== 'production') console.log("meals recipe");
  //     if (process.env.NEXT_PUBLIC_NODE_ENV !== 'production') console.log(breakfast);
  //     if (process.env.NEXT_PUBLIC_NODE_ENV !== 'production') console.log(lunch);
  //     if (process.env.NEXT_PUBLIC_NODE_ENV !== 'production') console.log(dinner);
  //   } catch (error) {
