...
export const Scribble = () => {
    ...
    return (
        <svg
            ...
            className="scribble-animation md:top-[150px] top-[400px] -z-10"
        >
            <mask
...
export const Scribble2 = () => {
    ...
    return (
        <div  className="absolute md:block hidden h-fit top-96 left-0 right-0">
            <svg width="1070" height="399" viewBox="0 0 1770 399" fill="none" xmlns="http://www.w3.org/2000/svg" >
